...
urlpatterns = [
    ...
    path('analisisFinanciero/actualizarEmpresa2', actualizarEmpresa2, name="actualizarEmpresa2"),
    path('analisisFinanciero/guardarModificacionEmpresa2', guardarModificacionEmpresa2, name="guardarModificacionEmpresa2"),
